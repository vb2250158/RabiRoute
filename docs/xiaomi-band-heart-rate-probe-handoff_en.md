...
Use the scripts and commands under `apps/rabi-mobile-android/` as the executable source of truth. Keep generated APKs, device dumps, decompiled applications, logs, account tokens, serial numbers, and personal health data out of Git.
