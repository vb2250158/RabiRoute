...
> 当前状态：Android 手机端探针已迁入 Rabi Link 命名体系，正式 APK 包名为 `com.rabi.link`，通用导出脚本为 `Export-RabiLinkProbeApk.ps1`。当前真实目录是 `apps/rabi-mobile-android/`，本文所有可执行命令均以该目录为准。
...
```text
apps/rabi-mobile-android/out/mi-health-logcat/mihealth-heart-records-20260704-163557.json
apps/rabi-mobile-android/out/mi-health-logcat/mihealth-heart-records-20260704-163557.csv
apps/rabi-mobile-android/out/mi-health-logcat/mihealth-heart-records-expanded-20260704-163557.csv
```
...
```powershell
cd <repo>\apps\rabi-mobile-android
...
```text
apps/rabi-mobile-android/out/apk/RabiLinkProbe-v<versionName>+<versionCode>-<yyyyMMdd-HHmmss>-debug.apk
```

脚本会同时生成 SHA256 文件。

注意：构建需要本机 Android/Gradle 环境，以及 `apps/rabi-mobile-android/app/libs/android-fit-20150719.jar`。
...
- `apps/rabi-mobile-android/out/`
- `apps/rabi-mobile-android/build/`
- `apps/rabi-mobile-android/app/build/`
- `apps/rabi-mobile-android/.gradle/`
- `apps/rabi-mobile-android/signing/`
- `apps/rabi-mobile-android/mi-health-*.json`
- `apps/rabi-mobile-android/mi-health-*.md`
