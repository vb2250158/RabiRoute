...
<p align="center">
  ...
  <img alt="Current version: 0.3.6" src="https://img.shields.io/badge/version-0.3.6-3178c6">
...
The repository version is `0.3.6`. The table lists behavior backed by current code, configuration surfaces, and tests. Features that require accounts, external services, or physical devices still need acceptance in their target environment.
