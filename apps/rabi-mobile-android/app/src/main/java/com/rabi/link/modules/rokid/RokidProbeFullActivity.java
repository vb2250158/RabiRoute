...
public class RokidProbeFullActivity extends Activity implements RokidProbeUi.Actions {
    private static final String TAG = "RokidProbeFullActivity";
    ...
    private void initCxrLink() {
        ...
        append("CXRLink 已初始化。");
        nativeVoiceBridge = new RokidNativeVoiceBridge(this, new RabiGlassBridge.Listener() {
            @Override
        ...
        glassPcBackend = new RabiGlassPcBackend(this, new RabiGlassPcBackend.Listener() {
            ...
            @Override
            public void onTranscript(String text, String routeProfileId) {
                if (nativeVoiceBridge != null) nativeVoiceBridge.sendGlassTranscript(text);
            }

            @Override
            public void onDeliveryState(String clientMessageId, String routeProfileId, String state, String failure) {
                if ("failed".equals(state)) appendOnUi("眼镜消息发送失败：" + failure);
            }
            ...
            @Override
            public void onPersonaAvatarChanged(String roleId, String avatarVersion, String avatarUrl) {
                appendOnUi("人格头像已更新：" + roleId);
            }
