...
```text
apps/rabi-mobile-android/out/rokid-native-voice/rokid-stack-*/rokid-native-voice-stack.json
apps/rabi-mobile-android/out/rokid-native-voice/rokid-stack-*/*.log
```
