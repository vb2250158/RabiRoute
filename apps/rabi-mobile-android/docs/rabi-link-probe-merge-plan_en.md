...
The active Android source, Gradle project, APK outputs, and phone recording/voice-capture code are all under `apps/rabi-mobile-android/`. Use this directory for the mobile app; the old probe workspace is archived outside `examples/`.
