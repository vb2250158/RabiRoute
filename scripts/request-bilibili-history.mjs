...
if (has("--help") || !value("--since")) {
  console.log(`Usage:
  node scripts/request-bilibili-history.mjs --since <date> [--until <date>] [--wait]

Examples:
  node scripts/request-bilibili-history.mjs --since 2026-06-29 --wait
  node scripts/request-bilibili-history.mjs --since 2025-01-01 --until 2025-02-01 --wait`);
...
const created = await request("/api/bilibili-history/jobs", {
  ...
  body: JSON.stringify({
    since: value("--since"),
    until: value("--until") || new Date().toISOString(),
