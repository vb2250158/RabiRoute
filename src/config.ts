...
export const config = {
  ...
  qclawGatewayUrl: process.env.QCLAW_GATEWAY_URL ?? "http://127.0.0.1:10978",
  qclawGatewayToken: process.env.QCLAW_GATEWAY_TOKEN ?? "",
  qclawModel: process.env.QCLAW_MODEL ?? "qclaw/pool-deepseek-v4-pro",
