...
export const config = {
  ...
  dshModelProvider: process.env.DSH_MODEL_PROVIDER?.trim() || "",
  dshModel: process.env.DSH_MODEL?.trim() || "",
  dshReasoningEffort: process.env.DSH_REASONING_EFFORT?.trim() || "",
  workbuddySessionId: process.env.WORKBUDDY_SESSION_ID?.trim() || "",
