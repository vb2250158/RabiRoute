...
.metric span { font-size: 12px; opacity: .74; }
...
.item-time, .item-meta { font-size: 12px; opacity: .65; }
...
.knowledge-evidence { grid-column: 1 / -1; opacity: .72; overflow-wrap: anywhere; }
